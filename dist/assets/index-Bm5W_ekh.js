...
function CodeEditor({ value, onChange, language = "javascript" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[400px] border rounded", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Ft,
    {
      height: "100%",
...
function ProblemDetails({ problem }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 bg-white p-4 overflow-y-auto", children: [
      ...
      activeTab === "My Solution" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CodeEditor,
          {
            value: userCode,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              disabled: isChecking,
              className: `px-6 py-3 rounded ${isChecking ? "bg-gray-400" : "bg-blue-500 hover:bg-blue-600"} text-white font-semibold`,
              children: isChecking ? "Checking..." : "Check Solution"
            }
          ),
          isChecking && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "Analyzing your solution..." })
        ] }),
        feedback && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-6 border rounded-lg bg-gray-50 whitespace-pre-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold mb-3", children: "AI Feedback:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "prose max-w-none", children: feedback })
        ] })
      ] })
    ] })
  ] });
